 ...
 *  - 图片打标：DashScope qwen-vl-max（与 scripts/import-styles.js --vlm 完全一致）
 *
 * 使用原生 https 模块，无额外依赖。
 */
...
/** 与 scripts/import-styles.js normalizeVlmTags 一致 */
...
/**
 * 调用 qwen-vl-max 对图片打美甲标准四标签（封闭词表）。
 * 逻辑与 scripts/import-styles.js tagWithVlm 一致：buildVlmPrompt + normalizeTag
